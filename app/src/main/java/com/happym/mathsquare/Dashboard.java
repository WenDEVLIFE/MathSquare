                    ...
                    if (!documentSnapshot.exists()) {
                        ...
                        statusRef.set(defaultStatus)
                                .addOnSuccessListener(aVoid ->
                                        Log.d("Quiz", quizId + " document created with default 'closed'"))
                                .addOnFailureListener(e ->
                                        Log.e("Quiz", "Failed to create document for " + quizId, e));
                    }

                    // Now attach real-time listener
                    attachSwitchListener(statusRef, switchCompat, quizId);
                })
                .addOnFailureListener(e ->
                        Log.e("Quiz", "Failed to fetch document for " + quizId, e));
    }

    private void attachSwitchListener(DocumentReference statusRef, SwitchCompat switchCompat, String quizId) {
        // Real-time updates
        ...
        // Update Firestore on switch toggle
